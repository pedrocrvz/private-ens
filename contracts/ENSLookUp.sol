...
contract ENSLookUp {
    ...
    function addressOf(bytes32 _node) 
    internal
    view 
    returns (address) {
        Resolver resolver = Resolver(ens.resolver(_node));
    ...
    function contenthashOf(bytes32 _node) 
    internal 
    view 
    ...
    function pubkeyOf(bytes32 _node) 
    internal 
    view 
    ...
    function textOf(bytes32 _node, string memory _key) 
    internal 
    view 
    returns (string memory) {
        Resolver resolver = Resolver(ens.resolver(_node));
